...
import { ProjectWithImages } from "@/lib/usePortfolioDataRemote";
...
export function Projects() {
    ...
    const categories = ["Todos", ...new Set(projects.map((p) => p.category))].filter(c => c);
                ...
                {isLoading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            ...
                            >
                                <div className="aspect-[16/10] bg-[#0A0A14]" />
                                <div className="p-6 space-y-3">
                                    <div className="h-5 bg-[#1A1A2E] rounded w-3/4" />
                                    <div className="h-4 bg-[#1A1A2E] rounded w-full" />
                                    <div className="flex gap-2 pt-2">
                                        <div className="h-6 w-16 bg-[#1A1A2E] rounded" />
                                        <div className="h-6 w-20 bg-[#1A1A2E] rounded" />
                                    </div>
                                </div>
                            </div>
                        ))}
                                            ...
                                            {project.image ? (
                                                <div className="absolute inset-0">
                                                    ...
                                                    <div
                                                        className="absolute inset-0"
                                                        style={{
                                                            background: "linear-gradient(to top, rgba(6,6,16,0.8) 0%, transparent 50%)",
                                                        }}
                                                    />
                                                </div>
                                            ) : (
